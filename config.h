...
#define PACKAGE_NAME "xdre"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "xdre 2.17"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xdre"
...
#define PACKEDATTR __attribute__((gcc_struct, packed))
...
/* Define this for xdre debugging */
/* #undef XDRE_DEBUG */
